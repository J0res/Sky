...
//        System.out.println("Connected to Bitget stream for symbol: " + symbol);
//        sendUpdateRequest();
//    }
//
//    @Override
...
//            priceController.updateBitGetData(
//                    symbol,
//                    averageBidPrice,
//                    averageAskPrice,
//                    bidTotalPrice,
...
//        try {
//            double high24h = data.getDouble("high24h");
//            double low24h = data.getDouble("low24h");
//            double volume24hInBaseCurrency = data.getDouble("quoteVolume"); //Вот тут что именно?
//            double lastPriceInUSDT = data.getDouble("lastPr"); //
//
//            double volume24hInUSDT = volume24hInBaseCurrency * lastPriceInUSDT; // Зачем умножать?
//
//            priceController.updateBitGetData(
//                    symbol,
...
//        String subscriptionMessageTicker = "{ \"op\": \"subscribe\", \"args\": [{\"instType\": \"SPOT\", \"channel\": \"ticker\", \"instId\": \"" + symbol + "\" }] }";
//        String subscriptionMessageDepth = "{ \"op\": \"subscribe\", \"args\": [{\"instType\": \"SPOT\", \"channel\": \"books5\", \"instId\": \"" + symbol + "\" }] }";
