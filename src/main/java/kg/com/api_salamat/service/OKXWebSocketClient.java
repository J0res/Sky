...
//        System.out.println("Connected to OKX stream for symbol: " + symbol);
//        sendUpdateRequest();
//    }
//
//    @Override
...
//            double volume24hInBaseCurrency = data.getDouble("vol24h");
//            double lastPriceInUSDT = data.getDouble("last");
//
...
//        String subscriptionMessageTicker = "{ \"op\": \"subscribe\", \"args\": [{ \"channel\": \"tickers\", \"instId\": \"" + symbol + "\" }] }";
//        String subscriptionMessageDepth = "{ \"op\": \"subscribe\", \"args\": [{ \"channel\": \"books5\", \"instId\": \"" + symbol + "\" }] }";
